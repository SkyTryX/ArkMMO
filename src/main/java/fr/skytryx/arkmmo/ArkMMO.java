...
import fr.skytryx.arkmmo.commands.guild.CommandGuildinvite;
import fr.skytryx.arkmmo.commands.guild.CommandGuildjoin;
import fr.skytryx.arkmmo.commands.guild.CommandGuildmsg;
...
public class ArkMMO extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(getCommand("guildmsg")).setExecutor(new
                CommandGuildmsg());
